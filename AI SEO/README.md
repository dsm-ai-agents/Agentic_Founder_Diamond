# Prompt 1 : AI SEO project
```
I provide [SERVICE/OFFER] and want to generate inbound leads through SEO in [CITY/LOCATION].
Research and list the search terms potential customers are already likely to use when they are actively looking to buy or hire this service.
Include:
High-buying-intent keywords
Local search variations
“Best”, “top”, “near me”, “company”, “consultant”, “expert”, “services”, “agency”, “provider” variations
Problem-based searches
Solution-based searches
Long-tail keywords
Industry-specific variations
Location + service combinations
Focus on keywords where the searcher is likely ready to enquire, book, hire, request a quote, or purchase, rather than purely informational searches.
Group the keywords by category and rank them by:
Buying intent
SEO opportunity
...
The goal is to rank for searches where potential customers are already:
...
**Search Demand × Buying Intent × Business Value × Ranking Feasibility**
